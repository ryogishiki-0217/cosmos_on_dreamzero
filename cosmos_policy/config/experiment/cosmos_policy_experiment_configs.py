...
cosmos_predict2_2b_480p_libero = LazyDict(
    dict(
        ...
        checkpoint=dict(
            ...
            load_path="/workspace/data1/Cosmos-Predict2-2B-Video2World/model-480p-16fps.pt",
...
cosmos_predict2_2b_480p_aloha_185_demos_4_tasks_mixture_foldshirt15_candiesinbowl45_candyinbag45_eggplantchickenonplate80__resumeFrom50K_648_rollouts_Vsprime_value_func = LazyDict(
    dict(
        ...
        checkpoint=dict(
            ...
            # ),
            load_path="/workspace/data1/Cosmos-Policy-ALOHA-Predict2-2B/Cosmos-Policy-ALOHA-Predict2-2B.pt",
        ),
        scheduler=dict(
